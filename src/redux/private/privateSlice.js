...
const privateSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(deleteConsumedProductForSpecificDay.fulfilled, (state, action) => {
            ...
            .addCase(deleteConsumedProductForSpecificDay.rejected, (state, action) => {
                state.isLoading = false;
                state.error = action.payload;
            })
            ...
            .addCase(fetchConsumedProductsForSpecificDay.fulfilled, (state, action) => {
                state.isLoading = false;
                const {
                    dailyCalorieIntake,
            ...
            .addCase(fetchConsumedProductsForSpecificDay.rejected, (state, action) => {
                state.isLoading = false;
                state.error = action.payload;
            });
    },
...
export const { setPrivateFormData, resetPrivateForm, clearMessage } = privateSlice.actions;
